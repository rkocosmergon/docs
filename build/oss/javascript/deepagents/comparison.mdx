...
<Tip>
    [Claude managed agents](https://platform.claude.com/docs/en/managed-agents/overview) is easy to get started with. If you want a similar low-friction path in the LangChain stack, use [LangSmith Fleet](/langsmith/fleet/index).
</Tip>
...
- **Choose Claude Agent SDK** if you are already invested in the Anthropic ecosystem and can use Claude Managed agents or wish to self-host and build the API, auth, and multi-tenant layers yourself.
